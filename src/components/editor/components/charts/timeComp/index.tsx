...
// class TimeComp extends React.Component<TimeCompProps>{
...
//         return (
//             <div className="base-comp-box">
//                 {this.props.node.chart?.format?.d?.show&&moment().format(this.props.node.chart?.format?.d?.fm)}
//                 &nbsp;
//                 {this.props.node.chart?.format?.t?.show&&moment().format(this.props.node.chart?.format?.t?.fm)}
//             </div>
//         )
//     }
// }
